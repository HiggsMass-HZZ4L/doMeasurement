...
class inputReader:
	...
	self.relerr_qqzz_gs_sigma = -999.
        self.relerr_ggzz_ld_mean = -999.
        self.relerr_ggzz_ld_sigma = -999.
        self.relerr_ggzz_ld_frac = -999.
        self.relerr_ggzz_gs_mean = -999.
        self.relerr_ggzz_gs_sigma = -999.
    ...
    def readInputs(self):
        ...
        for line in open(self.theInput,'r'):
            ...
            if f[0].lower().startswith("signaleff"):
                ...
                if f[1].lower().startswith("a5"): self.sigeff_a5 = float(f[2])
                ...
                if f[1].lower().startswith("b4"): self.sigeff_b4 = float(f[2])
                if f[1].lower().startswith("b5"): self.sigeff_b5 = float(f[2])
                ...
                if f[1].lower().startswith("qqha5"): self.sigeff_qqHa5 = float(f[2])
                ...
                if f[1].lower().startswith("qqhb4"): self.sigeff_qqHb4 = float(f[2])
                if f[1].lower().startswith("qqhb5"): self.sigeff_qqHb5 = float(f[2])
		...
		if f[1].startswith("relerr_qqzz_gs_sigma"): self.relerr_qqzz_gs_sigma =  f[2]		
                ...
                if f[1].startswith("relerr_ggzz_ld_frac"): self.relerr_ggzz_ld_frac =  f[2]
                if f[1].startswith("relerr_ggzz_ld_mean"): self.relerr_ggzz_ld_mean =  f[2]
                if f[1].startswith("relerr_ggzz_ld_sigma"): self.relerr_ggzz_ld_sigma =  f[2]
                if f[1].startswith("relerr_ggzz_gs_mean"): self.relerr_ggzz_gs_mean =  f[2]
                if f[1].startswith("relerr_ggzz_gs_sigma"): self.relerr_ggzz_gs_sigma =  f[2]
    ...
    def getInputs(self):
      ...
      ## Set dictionary entries to be passed to datacard class ##
        ...
        dict['sigEff_a5'] = float(self.sigeff_a5)
        dict['sigEff_b1'] = float(self.sigeff_b1)
        dict['sigEff_b2'] = float(self.sigeff_b2)
        dict['sigEff_b3'] = float(self.sigeff_b3)
        dict['sigEff_b4'] = float(self.sigeff_b4)
        dict['sigEff_b5'] = float(self.sigeff_b5)
        ...
        dict['sigEff_qqHa5'] = float(self.sigeff_qqHa5)
        ...
        dict['sigEff_qqHb4'] = float(self.sigeff_qqHb4)
        dict['sigEff_qqHb5'] = float(self.sigeff_qqHb5)
	...
	dict['relerr_qqzz_gs_sigma'] = self.relerr_qqzz_gs_sigma
        ...
        dict['relerr_ggzz_ld_frac'] = self.relerr_ggzz_ld_frac
        dict['relerr_ggzz_ld_mean'] = self.relerr_ggzz_ld_mean
        dict['relerr_ggzz_ld_sigma'] = self.relerr_ggzz_ld_sigma
        dict['relerr_ggzz_gs_mean'] = self.relerr_ggzz_gs_mean
        dict['relerr_ggzz_gs_sigma'] = self.relerr_ggzz_gs_sigma
