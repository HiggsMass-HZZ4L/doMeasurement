...
class systematicsClass:
    ...
    def Write_pdf_qqbar(self,theFile,theInputs):
        ...
        if not self.isForXSxBR:
            ...
            systLine['ttH']  = "- "
            systLine['qqZZ'] = "1.034 "#"{0:.4f} ".format(self.qqVV_pdfSys)
            systLine['ggZZ'] = "- "
            systLine['zjets']= "- "
            systLine['ttbar']= "- "
            systLine['zbb']  = "- "
    ...
    def Write_QCDscale_ggVV(self,theFile,theInputs):
        ...
        systLine['ttH']  = "- "
        systLine['qqZZ'] = "- " 
        systLine['ggZZ'] = "1.08 "#"{0:.4f} ".format(self.ggVV_scaleSys)
        systLine['zjets']= "- " 
        systLine['ttbar']= "- "
        systLine['zbb']  = "- "
    ...
    def Write_QCDscale_VV(self,theFile,theInputs):
        ...
        systLine['ZH']   = "- "
        systLine['ttH']  = "- "
        systLine['qqZZ'] = "1.028 "#"{0:.4f} ".format(self.qqVV_scaleSys) 
        systLine['ggZZ'] = "- "
        systLine['zjets']= "- " 
        systLine['ttbar']= "- "
        systLine['zbb']  = "- "
    ...
    def WriteShapeSystematics(self,theFile,theInputs):
        ...
        sigmaCB_e_errPerCent = 0.3 #theInputs['CMS_zz4l_sigma_e_sig']
        N_CB_errPerCent = theInputs['CMS_zz4l_n_sig']
        JES = theInputs['JES']
        meanCB_m_errPerCent = theInputs['CMS_zz4l_mean_m_sig']
        sigmaCB_m_errPerCent = 0.3 #theInputs['CMS_zz4l_sigma_m_sig']
        Gamma_BW_errPerCent = theInputs['CMS_zz4l_gamma_sig']
        
        if theInputs['useCMS_zz4l_doVBFtest']:
           theFile.write("JES param 0.0 {0} \n".format(JES))
